...
<template>
  <div class="h-20 flex items-center justify-between px-10">
    ...
    <div class="mr-8">
      <van-button icon="https://fastly.jsdelivr.net/npm/@vant/assets/user-active.png" type="primary" @click="open" />
    </div>
    ...
    <div
      ...
      <span class="block h-0.5 w-6 bg-white transform transition duration-300 ease-in-out"></span>
      <span class="block h-0.5 w-5 bg-white mt-1 transform transition duration-300 ease-in-out"></span>
      <span class="block h-0.5 w-4 bg-white mt-1 transform transition duration-300 ease-in-out"></span>
    </div>
    <!--setting modal-->
    <SettingModal />
  </div>
